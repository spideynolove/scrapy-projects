...
class CrawlerSpider(Spider):
    ...
    def parse_upcoming(self, response):
        ...
        # Bars data: this is historical data from different timeframes so need 1 file for them
    ...
    def parse_bars(self, response):
        ...
        # performace: (bar numbers + timeframe) list: this complex function need a file to store the data
